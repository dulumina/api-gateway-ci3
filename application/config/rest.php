...
|
*/
$config['rest_keys_table'] = $_ENV['REST_KEYS_TABLE'];
...
|
*/
$config['rest_enable_keys'] = $_ENV['REST_ENABLE_KEYS'];
...
|
*/
$config['rest_key_column'] = $_ENV['REST_KEY_COLUMN'];
...
|
*/
$config['rest_key_name'] = $_ENV['REST_KEY_NAME'];
...
|
*/
$config['rest_enable_logging'] = $_ENV['REST_ENABLE_LOGGING'];
...
|
*/
$config['rest_logs_table'] = $_ENV['REST_LOGS_TABLE'];
